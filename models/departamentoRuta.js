...
let DepartamentoRuta = class DepartamentoRuta {
    constructor(cod, codDep, codRut, fech) {
        this.codDepartamentoRuta = cod;
        this.codDepartamento = codDep;
        this.codRuta = codRut;
        this.fechaCreacionDepartamentoRuta = fech;
    }
};
__decorate([
...
__decorate([
    (0, typeorm_1.Column)("integer", { name: "codDepartamento" }),
    __metadata("design:type", Number)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => departamento_1.default, (ObjDepartamento) => ObjDepartamento.departamentoRuta, {
...
DepartamentoRuta = __decorate([
    (0, typeorm_1.Entity)("departamento_rutas", { schema: "public" }),
