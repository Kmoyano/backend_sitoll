...
let Peaje = class Peaje {
    constructor(cod, nom, cla, fotoPu, fotoPri) {
        this.codPeaje = cod;
        this.codRuta = nom;
        this.nombrePeaje = cla;
...
__decorate([
    (0, typeorm_1.Column)("character varying", { name: "nombre_peaje", length: 250 }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => puesto_1.default, (objPuesto) => objPuesto.codPuesto),
    __metadata("design:type", Array)
], Peaje.prototype, "puestoRuta", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => ruta_1.default, (ObjRuta) => ObjRuta.peajeRuta, { onDelete: "RESTRICT", onUpdate: "CASCADE" }),
    (0, typeorm_1.JoinColumn)([{
            name: "cod_ruta", referencedColumnName: "codRuta"
        }]),
    __metadata("design:type", ruta_1.default)
], Peaje.prototype, "codRutaD", void 0);
Peaje = __decorate([
