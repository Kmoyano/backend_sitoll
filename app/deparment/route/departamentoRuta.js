...
class DepartamentoRuta {
    ...
    cargarRutas() {
        ...
        this.apiRutaDepartamento.get("/list", departamentoControlador_1.default.listarDepartamento);
        this.apiRutaDepartamento.put("/update", departamentoControlador_1.default.actulizarDepartamento);
        this.apiRutaDepartamento.delete("/delete/:codDepartamento", departamentoControlador_1.default.eliminarDepartamento);
        this.apiRutaDepartamento.get("/one/:codDepartamento", departamentoControlador_1.default.unoDepartamento);
    }
}
